...
function validationDemo() {
    ...
    $('button.show-multiple-errors').click(function(event) {
        ...
        $('.validation-demo .usa-alert ul.usa-checklist').empty().append(
            '<li>The <a>Systolic</a> value is outside the expected range.</li>\n' +
            '<li><a>Diastolic</a> should be less than <a>Systolic</a>. Please check the values.</a></li>\n' +
            '<li><a>Pulse</a> field is required.</li>'
        );
